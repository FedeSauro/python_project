...
import math
import json 
data = json.load(open("C:\\Users\\dpc-covid19-ita-province.json"))

# feder\\OneDrive\\Documenti\\Fede\\University\\STAT_M1\\AlgoritmiPython\\project\\
...
# Datasets ordered per lat and long
...
# Method optimized with binarySearch
P = nx.Graph()
...
# Adding distance to have weighted graph
